...
若找不到邀请人，也可以填写[注册元石云账户电子表格](https://go.shiyun.work/eforms/register/index.html)，申请加入白名单。

### 邀请加入白名单相关规定

每位拥有metaShiyun账户的玩家可以在每个季度邀请一人加入白名单。

请填写[注册元石云账户电子表格](https://go.shiyun.work/eforms/register/index.html)，然后联系Admin级及以上级别管理员完成邀请流程。
